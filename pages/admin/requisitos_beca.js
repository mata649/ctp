...
const RequisitosBeca = () => {
  ...
  const handleUpdateGeneralInformation = async (e) => {
    ...
    try {
      await GeneralInformationService.updateGeneralInformationGeneralInformationPut(
        {
          ...generalInformation,
          scholarship_requirements: draftjsToHtml(
  ...
  return (
    <div className="container">
      <h1 className="text-center mt-5">Requisitos de Beca</h1>
      <TextEditorContainer>
